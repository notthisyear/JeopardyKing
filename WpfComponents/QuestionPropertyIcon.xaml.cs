...
{
    public partial class QuestionPropertyIcon : UserControl
    {
        ...
        {
            if (d is QuestionPropertyIcon icon && e.NewValue is IconType newType && e.OldValue is IconType oldType && newType != oldType)
